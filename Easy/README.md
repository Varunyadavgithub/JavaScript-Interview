...
6.  [What are arrays in JavaScript ?](Arrays-in-JS.md)
7.  [What is the purpose of the `alert`, `prompt`, and `confirm` methods in JavaScript ?](Alert-prompt-confirm.md)
8.  [What are template literals in JavaScript, and how are they used ?](Template-literals-in-JS.md)
9.  [What is the difference between `for`, `while`, and `do...while` loops in JavaScript ?](Difference-between-loops.md)
